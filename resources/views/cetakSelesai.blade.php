...
<body>
        <p style="position:absolute; top:25%; left:21%; font-size:7rem; padding:10px 20px; color:rgba(0,255,0,0.31); transform:rotate(20deg); font-weight:bold;">PAIDED</p>
        ...
        <h5>Tanggal Verifikasi : {{ $order->updated_at }}</h5>
